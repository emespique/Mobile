...
class SentCompQuiz2 extends StatefulWidget {
  const SentCompQuiz2(
      {super.key,
  ...
  @override
  _SentCompQuiz2State createState() => _SentCompQuiz2State();
}

class _SentCompQuiz2State extends State<SentCompQuiz2> {
  ...
  Future<void> fetchQuestions() async {
    try {
      ...
      var snapshot = await FirebaseFirestore.instance
          ...
          .collection('Medium') // Difficulty Collection
          .doc('yVZ7S6Wo5QIOLRF8Npmx') // Module Document
          .get();
  ...
  Future<void> submitQuiz() async {
    ...
    await FirebaseFirestore.instance
        ...
        .doc('$userId-Sentence Composition-Medium') // Specific document
        .set({
      'status': 'COMPLETED',
