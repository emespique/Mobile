...
class ReadCompQuiz2 extends StatefulWidget {
  ...
  @override
  _ReadCompQuiz2State createState() => _ReadCompQuiz2State();
}

class _ReadCompQuiz2State extends State<ReadCompQuiz2> {
  int score = 0;
  int mistakes = 0;
    ...
    try {
      if (widget.uniqueIds.isNotEmpty) {
        final querySnapshot = await FirebaseFirestore.instance
            ...
            .collection('Medium') // Focused on medium difficulty
            .doc('2jOvLgO48hHIMAwpi1qx')
            .get();
